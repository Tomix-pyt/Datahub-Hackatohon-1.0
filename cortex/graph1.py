...
def investigate(state: CortexState) -> CortexState:
    ...
    # Real diagnosis using actual evidence — incident description, real
    # current asset state, and any known diff. In mock mode this still
    # returns deterministic fixture text (see llm.py); in live mode it's
    # a real LLM call grounded in what was actually fetched from DataHub.
